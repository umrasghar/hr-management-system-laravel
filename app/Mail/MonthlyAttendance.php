...
class MonthlyAttendance extends Mailable implements ShouldQueue
{
    ...
    public function __construct(Company $company)
    {
        ...
        // Get Previous Month. We added subweek. So we move to previous month rather adding subMonth
        // Doing Submonth minus 1 complete month. So it completely depends on timezone. if we are getting previous month or previous to previous month

        $this->previousMonth = now()->timezone($company->timezone)->subWeek();

        ...
        foreach ($period as $date) {
            ...
            foreach ($clockins as $value) {
                ...
                if (!is_null($value)) {
                    ...
                    $this->startTime = Carbon::parse($value->clock_in_time)->timezone($this->company->timezone);

                    if (!is_null($value->clock_out_time)) {
                        $this->endTime = Carbon::parse($value->clock_out_time)->timezone($this->company->timezone);
                    }
